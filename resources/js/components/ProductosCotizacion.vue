            ...
            <div class="form-group row">
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" v-model="buscar" @keyup.enter="listarProductosCotizacion(1,buscar,criterio,identificador)" class="form-control" placeholder="Texto a buscar">
                                        <button type="submit" @click="listarProductosCotizacion(1,buscar,criterio,identificador)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    export default {
        ...
        methods : {
                listarProductosCotizacion(page,buscar,criterio,identificador){
                let me=this;
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listarProductosCotizacion(page,buscar,criterio,this.identificador);
            }
        },
        mounted() {
            this.listarProductosCotizacion(1,'','',this.identificador)
        }
    }
</script>
<style>
